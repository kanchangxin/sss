 ...
 *
 * Project Name: sss
 * $Id:  RoleResourceController.java 2015-11-06 15:47:20 $
 */
...
public class RoleResourceController extends AbstractAdminController<IRoleResourceService>{
    ...
    @ResponseBody
    public BizData4Page findAllRoleResources(HttpServletRequest request,HttpServletResponse response){
