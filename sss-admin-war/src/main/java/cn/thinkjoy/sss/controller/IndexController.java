...
public class IndexController extends    AbstractAdminController<IResourceService> {
    ...
    public ModelAndView index(HttpServletRequest request, HttpServletResponse response) {
        ...
        List resourceGridList = this.resourceGridService.findList("moduleName", getMainObjName());
