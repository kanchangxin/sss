 ...
 *
 * Project Name: sss
 * $Id:  UserDatagroupController.java 2015-11-06 15:47:20 $
 */
...
public class UserDatagroupController extends AbstractAdminController<IUserDatagroupService>{
     ...
     */
    @RequestMapping(value="/userdatagroup")
     ...
     * @return
     */
    @RequestMapping(value="/userdatagroups")
    @ResponseBody
    public BizData4Page findAllUserDatagroups(HttpServletRequest request,HttpServletResponse response){
        return doPage(request, response);
    }

    @Override
    protected IUserDatagroupService getMainService() {
        return userDatagroupService;
    }
